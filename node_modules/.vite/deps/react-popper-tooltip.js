...
function usePopperTooltip(config, popperOptions) {
  ...
  var defaultModifiers3 = React6.useMemo(function() {
    return [{
      name: "offset",
      options: {
  ...
  var isTriggeredBy = React6.useCallback(function(trigger) {
  ...
  React6.useEffect(function() {
    if (!getLatest().finalConfig.closeOnOutsideClick)
      return;
    var handleClickOutside = function handleClickOutside2(event) {
  ...
  React6.useEffect(function() {
    if (triggerRef == null || !isTriggeredBy("right-click"))
      return;
    var preventDefaultAndToggle = function preventDefaultAndToggle2(event) {
  ...
  var getTooltipProps = function getTooltipProps2(args) {
    if (args === void 0) {
      args = {};
    }
  ...
  var getArrowProps = function getArrowProps2(args) {
    if (args === void 0) {
      args = {};
    }
