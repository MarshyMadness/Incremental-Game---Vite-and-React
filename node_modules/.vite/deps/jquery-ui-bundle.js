    ...
    (function(factory) {
      ...
      $.Widget.prototype = {
        ...
        _trigger: function(type, event, data2) {
          ...
          return !($.isFunction(callback) && callback.apply(this.element[0], [event].concat(data2)) === false || event.isDefaultPrevented());
        }
      };
          ...
          return this.each(function() {
            ...
            $.each(["left", "top"], function(i, dir) {
              if ($.ui.position[collision[i]]) {
                $.ui.position[collision[i]][dir](position2, {
                  targetWidth,
                  targetHeight,
                  elemWidth,
                  elemHeight,
            ...
            elem.offset($.extend(position2, { using }));
          });
        };
        $.ui.position = {
          fit: {
      ...
      var scrollParent = $.fn.scrollParent = function(includeHidden) {
        ...
        return position2 === "fixed" || !scrollParent2.length ? $(this[0].ownerDocument || document) : scrollParent2;
      };
      ...
      var plugin = $.ui.plugin = {
        add: function(module2, option, set) {
          var i, proto = $.ui[module2].prototype;
          for (i in set) {
      ...
      var safeActiveElement = $.ui.safeActiveElement = function(document2) {
        var activeElement;
        try {
      ...
      $.widget("ui.draggable", $.ui.mouse, {
        ...
        _getParentOffset: function() {
          ...
          if (this.cssPosition === "absolute" && this.scrollParent[0] !== document2 && $.contains(this.scrollParent[0], this.offsetParent[0])) {
        ...
        _setContainment: function() {
          ...
          if (o.containment === "window") {
            this.containment = [
              ...
              $(window).scrollTop() + ($(window).height() || document2.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top
            ];
            return;
          }
          if (o.containment === "document") {
            this.containment = [
              0,
              0,
              $(document2).width() - this.helperProportions.width - this.margins.left,
              ($(document2).height() || document2.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top
            ];
            return;
          }
      ...
      $.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(event, ui, i) {
          ...
          if (scrollParent2 !== document2 && scrollParent2.tagName !== "HTML") {
            ...
            if (!o.axis || o.axis !== "x") {
              if (event.pageY - $(document2).scrollTop() < o.scrollSensitivity) {
                scrolled = $(document2).scrollTop($(document2).scrollTop() - o.scrollSpeed);
              } else if ($(window).height() - (event.pageY - $(document2).scrollTop()) < o.scrollSensitivity) {
                scrolled = $(document2).scrollTop($(document2).scrollTop() + o.scrollSpeed);
              }
            }
            if (!o.axis || o.axis !== "y") {
              if (event.pageX - $(document2).scrollLeft() < o.scrollSensitivity) {
                scrolled = $(document2).scrollLeft($(document2).scrollLeft() - o.scrollSpeed);
              } else if ($(window).width() - (event.pageX - $(document2).scrollLeft()) < o.scrollSensitivity) {
                scrolled = $(document2).scrollLeft($(document2).scrollLeft() + o.scrollSpeed);
              }
            }
          }
      ...
      $.ui.plugin.add("resizable", "animate", {
        stop: function(event) {
          ...
          that.element.animate($.extend(style, top && left ? { top, left } : {}), {
            ...
            step: function() {
              ...
              if (pr && pr.length) {
                $(pr[0]).css({ width: data2.width, height: data2.height });
              }
      ...
      var widgetsControlgroup = $.widget("ui.controlgroup", {
        ...
        _initWidgets: function() {
          ...
          $.each(this.options.items, function(widget2, selector) {
            var labels2;
            var options = {};
            if (!selector) {
              return;
            ...
            that.element.find(selector).each(function() {
              ...
              $.data(widgetElement[0], "ui-controlgroup-data", instance ? instance : element[widget2]("instance"));
        ...
        _callChildMethod: function(method) {
          this.childWidgets.each(function() {
            var element = $(this), data2 = element.data("ui-controlgroup-data");
      ...
      $.widget("ui.checkboxradio", [$.ui.formResetMixin, {
        ...
        _getCreateOptions: function() {
          ...
          this.label = $(labels2[labels2.length - 1]);
      ...
      $.extend(Datepicker.prototype, {
        ...
        _determineDate: function(inst, date, defaultDate) {
          var offsetNumeric = function(offset) {
            ...
            var date2 = (offset.toLowerCase().match(/^c/) ? $.datepicker._getDate(inst) : null) || new Date(), year = date2.getFullYear(), month = date2.getMonth(), day = date2.getDate(), pattern = /([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, matches = pattern.exec(offset);
            while (matches) {
              switch (matches[2] || "d") {
                case "d":
                case "D":
        ...
        _ajaxSettings: function(anchor, event, eventData) {
          ...
          return {
            ...
            beforeSend: function(jqXHR, settings) {
              return that._trigger("beforeLoad", event, $.extend({ jqXHR, ajaxSettings: settings }, eventData));
            }
          };
        },
      ...
      var dataSpace = "ui-effects-", dataSpaceStyle = "ui-effects-style", dataSpaceAnimated = "ui-effects-animated", jQuery2 = $;
      $.effects = {
        effect: {}
      };
      (function(jQuery3, undefined2) {
            ...
            if (type === "object") {
              if (red instanceof color) {
                ...
                each(spaces, function(spaceName, space) {
                  ...
                  if (inst[cache] && jQuery3.inArray(null, inst[cache].slice(0, 3)) < 0) {
                    inst[cache][3] = 1;
                    if (space.from) {
        ...
        each(spaces, function(spaceName, space) {
          ...
          color.fn[spaceName] = function(value) {
            ...
            var ret, type = jQuery3.type(value), arr = type === "array" || type === "object" ? value : arguments, local = this[cache].slice();
          ...
          each(props, function(key, prop) {
            ...
            color.fn[key] = function(value) {
              var vtype = jQuery3.type(value), fn = key === "alpha" ? this._hsla ? "hsla" : "rgba" : spaceName, local = this[fn](), cur = local[prop.idx], match;
              if (vtype === "undefined") {
                return cur;
              }
              if (vtype === "function") {
      ...
      (function() {
        ...
        function _normalizeArguments(effect2, options, speed, callback) {
          ...
          if (options) {
            $.extend(effect2, options);
          }
          speed = speed || options.duration;
          effect2.duration = $.fx.off ? 0 : typeof speed === "number" ? speed : speed in $.fx.speeds ? $.fx.speeds[speed] : $.fx.speeds._default;
...
// dep:jquery-ui-bundle
var jquery_ui_bundle_default = require_jquery_ui();
export {
  jquery_ui_bundle_default as default
};
/*!
...
//# sourceMappingURL=jquery-ui-bundle.js.map
